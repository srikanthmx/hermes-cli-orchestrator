...
MEDIA_CATALOG: List[Dict[str, Any]] = [
    ...
    # ── Video generation (framework present, backends are plugins) ───────────
    {"id": "fal-video", "name": "fal Video", "category": "Video", "kind": "plugin",
     "mechanism": "video_gen plugin (not bundled)", "env": ["FAL_KEY"],
     "signup": "https://fal.ai/dashboard/keys", "docs": "https://fal.ai"},
    {"id": "runway", "name": "Runway", "category": "Video", "kind": "plugin",
     "mechanism": "video_gen plugin (not bundled)", "env": ["RUNWAYML_API_SECRET"],
     "signup": "https://dev.runwayml.com", "docs": "https://runwayml.com"},
    {"id": "luma", "name": "Luma Dream Machine", "category": "Video", "kind": "plugin",
     "mechanism": "video_gen plugin (not bundled)", "env": ["LUMAAI_API_KEY"],
     "signup": "https://lumalabs.ai/dream-machine/api", "docs": "https://lumalabs.ai"},
    # ── Music generation (not native — skill/plugin) ─────────────────────────
    {"id": "suno", "name": "Suno", "category": "Music", "kind": "plugin",
     "mechanism": "skill / custom tool (no official API)", "env": ["SUNO_API_KEY"],
     "signup": "https://suno.com", "docs": "https://suno.com"},
    {"id": "udio", "name": "Udio", "category": "Music", "kind": "plugin",
     "mechanism": "skill / custom tool", "env": ["UDIO_API_KEY"],
     "signup": "https://udio.com", "docs": "https://udio.com"},
]
